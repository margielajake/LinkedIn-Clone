  ...
  return (
    <div className="flex justify-evenly my-2 border-b-2">
      <div className="sticky top-0 flex items-center m-0">
          <img src="https://img.icons8.com/doodle/256/linkedin--v2.png" alt="linkedin-icon" style={{objectFit: 'contain', height: 40}} />
          <div className="search-input m-2 flex items-center justify-center border bg-gray-200 rounded-md h-10">
          <SearchIcon />
